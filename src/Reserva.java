...
public class Reserva extends JDialog {
    ...
    marques.addItem(res.getString("marque"));
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {	
				setVisible(false);
				 new Clients_reservation( numero.getText(),marques.getSelectedItem(), modele.getSelectedItem(),"attente",kilometre.getText(), prix.getText());
				 new Clients_reservation(null, "Réservation : Informations Clients", true);
