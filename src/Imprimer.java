...
import java.util.Properties;
  ...
  {  
    ...
    Imprimer()
    {
    	...
    	setTitle("Réservation d'un vehicule");
    	Border[] listBorder = {	
...
//info client
		...
		int prixht = qte*pri;
	    int ttc = tva+prixht;
		Object[][] data = {	{"Réservation de voiture", marque,modele,prix+",00",qte,tva+",00",prixht+",00", ttc+",00"}
			
		};

		String  title[] = {"Designation","marque","Modèle","Prix Unitaire", "Qté","TVA","Prix HT","TTC"};
		int Timbre = 400;
    ...
    JTable tableau2 = new JTable(data2, title2);
		...
		String str = "Remarque : La société n'est pas responsable de la non ";
		String str1 = "disponibilté de la voiture à cause d'un retard faite par un client ";
		String str2 = "En cas ou le locataire annule sa réservation, la société ";
		String str3 = "a le droit de garder 40% du montant payé (ces condition ont en effet ajour) ";
