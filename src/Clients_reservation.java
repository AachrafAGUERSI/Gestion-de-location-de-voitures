	...
	private void initComponent(){
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {		
				...
				setVisible(false);
			      new Imprimer( numero,marque, modele,etat,kilometrage, prix, nom.getText(), prenom.getText(), securite_social.getText(), adresse.getText(), telephone.getText(), numero_permis.getText());
