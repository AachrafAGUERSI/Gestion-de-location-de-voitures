...
public class Clients extends JDialog {
	...
	public Clients(JFrame parent, String title, boolean modal){
	...
	public Clients(String numero, Object marque, Object modele,  String etat,
	...
	private void initComponent(){
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {		
				...
				setVisible(false);
			      new EssaiImprimer( numero,marque, modele,etat,kilometrage, prix, nom.getText(), prenom.getText(), securite_social.getText(), adresse.getText(), telephone.getText(), numero_permis.getText());
