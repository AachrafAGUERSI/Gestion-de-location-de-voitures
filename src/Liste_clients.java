...
public class Liste_clients extends JFrame  {
	...
	private String requete = "SELECT nom FROM client ";

		
		
	public Liste_clients(String requete) {
	...
	public void initContent(){
		//le meme copier coller
		// chuff hadi a chaque fois kankhedmuha 39el 3liha
