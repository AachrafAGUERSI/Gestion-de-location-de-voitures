...
public class Location extends JDialog {
	...
	public Location(JFrame parent, String title, boolean modal) throws RemoteException, SQLException, MalformedURLException, NotBoundException{
	...
	public Location(String adr, Interfaces Location) {
    ...
    marques.addItem(res.getString("marque"));
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {	
				setVisible(false);
				 new Clients( numero.getText(),marques.getSelectedItem(), modele.getSelectedItem(),"sortie",kilometre.getText(), prix.getText());
				new Clients(null, "Contrat : Informations Clients", true);
